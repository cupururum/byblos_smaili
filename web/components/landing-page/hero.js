...
function Hero(props) {
    ...
    return (
        <div className="bg-romance pt-28">
            ...
            <div className="mt-32 mb-28 px-12 text-mobileIntroTextDesk text-center lg:mx-24 lg:mt-0 lg:mb-20 dxl:mx-40 4xl:h-68 4xl:px-0 4xl:mx-108  4xl:mt-24">
                <div className=" mb-20 lg:mb-5 xl:mb-6 dxl:mb-8 4xl:mb-16">
                    <p className="md:px-24  lg:text-introTextDesk ">Prawdziwa kuchnia libańska ma niepowtarzalny smak.</p>
                    <p className="hidden md:block md:px-12 lg:px-24 lg:text-bodytextAdress">Kombinacje przypraw oraz duża ilość warzyw sprawiają, że dania kuchni libańskiej są niezwykle różnorodne zarówno pod względem smaku, jak i kolorystyki.</p>
                </div>
            ...
            <div className="flex justify-between h-132 lg:h-88 xl:h-100 dxl:h-116 2xl:h-128  4xl:h-180">
