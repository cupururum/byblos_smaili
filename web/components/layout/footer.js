...
function Footer(props) {
 ...
 return(
    <footer className="bg-romance px-16 pt-24 h-156 xsm:px-24 md:flex md:justify-between  md:h-96 md:px-10 md:pt-16 lg:h-36 lg:py-8 lg:px-16 xl:h-28 xl:py-6 xl:px-20 2xl:px-36 ">
