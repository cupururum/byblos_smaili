...
function Footer(props) {
 ...
 return(
    <footer className="w-full px-16 pt-24 h-156  bg-romance xsm:px-24 md:flex md:justify-between  md:h-96 md:px-10 md:pt-16 lg:h-36 lg:py-8 lg:px-16 xl:h-28 xl:py-6 xl:px-20 2xl:px-36 ">
            ...
            <div className="lg:flex lg:space-x-10">   
                ...
                <button className="w-56 h-16 mt-16  text-buttonJumbotron font-bold bg-white focus:outline-none md:w-84 lg:w-56 lg:hover:bg-btn-color-hover lg:mt-1" >
                    Rezerwacja
                </button>
            ...
            <div className="mt-16  text-dusty-creme md:hidden">
                    <p className="inline-block mr-2 xsm:mr-3 ">© 2021 Byblos</p>
                    <p className="inline-block">Privacy Policy</p>
            </div>
