    ...
    return(
        <div  className="flex w-86 h-36">
                <div className="relative bg-white-coffee bg-opacity-50 w-36 h-36 ">
                    ...
                    <img className={`object-fill w-36 h-36 p-0`} src={props.pic} alt={props.alt}/>
                </div>  
                ...
                <div className="relative ml-8 pl-1 w-32"> 
                        ...
                        <div className="absolute  bottom-0 left-0  box-content w-12 h-8 px-1 pb-1 ml-1 border-l-2 border-r-2 border-black bg-black text-white text-socialCardText font-bold text-center ">{props.price}</div>
